...
return new class extends Migration {
    public function up(): void
    {
        ...
        if (! Schema::exists($tableNames['permissions'])) {
        ...
        if (! Schema::exists($tableNames['roles'])) {
        ...
        if (! Schema::exists($tableNames['model_has_permissions'])) {
        ...
        if (! Schema::exists($tableNames['model_has_roles'])) {
        ...
        if (! Schema::exists($tableNames['role_has_permissions'])) {
